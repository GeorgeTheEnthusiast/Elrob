namespace Elrob.Webservice.Controllers
{
    ...
    public class EmailSenderController : IEmailSenderController
    {
        ...
        {
            _logger.Info("Sending email to {0} with subject {1}", _configurationManager.DailyReportRecipient, subject);

            MailAddress mailAddressFrom = new MailAddress("elrob.terminal@gmail.com", "Elrob.Terminal");
            MailAddress mailAddressTo = new MailAddress(_configurationManager.DailyReportRecipient);
